...
struct range {
	const_value *child1;
	const_value *child2;
	range(const_value *c1, const_value *c2):child1(c1),child2(c2) {}
...
struct proc_stmt {
	...
	proc_stmt(identifier *c1):choice1(1) { child1.choice1 = c1; }
	proc_stmt(identifier *c11,args_list *c12):choice1(2) {
		child1.choice2.child1 = c11;
		child1.choice2.child2 = c12;
	}
	proc_stmt(sys_proc *c1):choice1(3) { child1.choice3 = c1; }
	proc_stmt(sys_proc *c11,expression_list *c12):choice1(4) {
		child1.choice4.child1 = c11;
		child1.choice4.child2 = c12;
	}
	proc_stmt(factor *c1):choice1(5) { child1.choice5 = c1; }
	bool semanticCheck(int scope);
	std::string cgen();
};
